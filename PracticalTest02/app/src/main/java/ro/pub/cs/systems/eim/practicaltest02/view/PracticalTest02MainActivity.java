...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private EditText cuvant_edit_text = null;
    private EditText nr_litere_edit_text = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String cuvant = cuvant_edit_text.getText().toString();
            String nr_litere = nr_litere_edit_text.getText().toString();
            if (cuvant == null || cuvant.isEmpty()
                    || nr_litere == null || nr_litere.isEmpty()) {
                Toast.makeText(getApplicationContext(), "[MAIN ACTIVITY] Parameters from client (city / information type) should be filled", Toast.LENGTH_SHORT).show();
                return;
            }

            result_text_view.setText(Constants.EMPTY_STRING);

            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), cuvant, Integer.parseInt(nr_litere), result_text_view
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cuvant_edit_text = (EditText)findViewById(R.id.cuvant_edit_text);
        nr_litere_edit_text = (EditText)findViewById(R.id.nr_litere_edit_text);
